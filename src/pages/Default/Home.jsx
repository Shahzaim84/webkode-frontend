...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              <button
                className="px-4 py-2 rounded-md text-gray-900 hover:bg-gray-100 transition cursor-pointer"
      ...
      <section
        ref={heroRef}
        className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 hero-content"
      >
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto mb-10">
            Supercharge your workflow with blazing-fast APIs and tools that just
            work all in one place.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button
              className="px-8 py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 transition transform hover:scale-105 cursor-pointer"
              onClick={() => navigate("/register")}
            >
              Get Started
            </button>
            <button
              className="px-8 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition transform hover:scale-105 cursor-pointer"
              onClick={() => navigate("/login")}
            >
              Login
            </button>
          ...
          <div className="relative h-80 bg-gradient-to-r from-red-50 to-gray-50 rounded-2xl overflow-hidden border border-gray-200">
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="grid grid-cols-3 gap-6 p-6 w-full">
                <div className="bg-white p-6 rounded-xl shadow-lg flex flex-col items-center justify-center cursor-pointer hover:scale-105 transition-all ease-in duration-300">
                  <AiFillCode className="w-10 h-10 mb-3 text-[#fe121a]" />
                  <p className="text-sm font-medium text-[#fe121a]">
                    Instant APIs
                  </p>
                </div>
                <div className="bg-white p-6 rounded-xl shadow-lg flex flex-col items-center justify-center cursor-pointer hover:scale-105 transition-all ease-in duration-300">
                  <AiOutlineSecurityScan className="w-10 h-10 mb-3 text-[#fe121a]" />
                  <p className="text-sm font-medium text-[#fe121a]">
                    Secure Auth
                  </p>
                </div>
                <div className="bg-white p-6 rounded-xl shadow-lg flex flex-col items-center justify-center cursor-pointer hover:scale-105 transition-all ease-in duration-300">
                  <AiOutlineRocket className="w-10 h-10 mb-3 text-[#fe121a]" />
                  <p className="text-sm font-medium text-[#fe121a]">
                    Fast Access
                  </p>
                </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-red-600 text-white cta-section">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-red-100 mb-10 max-w-2xl mx-auto">
            A modern toolkit to test, deploy, and manage your APIs in one place
...
const features = [
  {
    ...
    description:
      "Personalized dashboards for admins, developers, and managers — each with tools that matter.",
  },
  {
    icon: <FaLock size={20} />,
    title: "Secure Data Exchange",
    description:
      "End-to-end encrypted transfers ensure your files and data stay protected at every step.",
  },
  {
    icon: <FaFileInvoiceDollar size={20} />,
    title: "Automated Invoicing",
    description:
      "Smart billing with auto-generated invoices, real-time tracking, and client reminders.",
  },
  {
    icon: <FaTerminal size={20} />,
    title: "Built-in Dev Toolkit",
    description:
      "Access terminal, test APIs, manage code snippets — all inside your workflow hub.",
  },
];
