          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="relative">
                  <input
                    ...
                    className={
                      "w-full px-4 py-3 border border-[#e5e7eb] rounded-xl focus:ring-2 focus:ring-[#fe121a]/50 transition-all pr-12 outline-none"
                    }
                    placeholder="••••••••"
                  />
                  <button
              ...
              <div className="flex flex-col gap-2">
                ...
                {errors.length > 0 && (
                  <p className="text-red-500 text-sm animate-shake">{errors}</p>
                )}
              </div>
              ...
              >
                {btnLoading ? <BeatLoader color="#fff" size={10} /> : "Reset Password"}
              </button>
